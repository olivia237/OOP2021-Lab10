...
public final class LambdaFilter extends JFrame {
    ...
    private enum Command {
    	...
    	LOWERCASE("ToLowercase", (e -> e.toLowerCase())),
    	NUMBER_OF_CHARS("CountChars", (e -> Integer.toString(e.length()))),
        NUMBER_OF_LINES("CountLines", (i->Long.toString(i.chars().filter(e-> e == '\n').count()+1)),
    	ALPHABETICAL_ORDER("WordsInAlfabeticalOrder",(e->Arrays.stream(e.split("(\\s|\\p{Punct})+"))
    															.sorted()
